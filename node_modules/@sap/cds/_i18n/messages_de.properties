...
ASSERT_RANGE=Geben Sie einen Wert zwischen {1} und {2} ein.
#XMSG: Enter a valuematching the pattern /^abc/.
ASSERT_FORMAT=Geben Sie einen Wert im Format {1} ein.
#XMSG: Enter one of the allowed values: High,Medium,Low. // Implementation still provides 2 values
ASSERT_ENUM=Geben Sie einen der folgenden Werte ein: {1}
#XMSG: Provide the missing value. // Error text displayed on a field, in case a mandatory value is not set.
ASSERT_MANDATORY=Geben Sie den fehlenden Wert ein.
#XMSG: Target with this key doesn't exist.
ASSERT_TARGET=Kein Ziel mit dieser ID gefunden

# Aggregating Error

#XMSG
MULTIPLE_ERRORS=Mehrere Fehler aufgetreten; Details siehe unten
...
INVALID_FLOW_TRANSITION_SINGLE=Aktion "{0}" ben\u00F6tigt "{1}", um "{2}" zu sein.
#XMSG: Action "cancelTravel" requires "travelStatus" to be one of the following values: Open,Accepted.
INVALID_FLOW_TRANSITION_MULTI=Aktion "{0}" ben\u00F6tigt "{1}", um einer der beiden folgenden Werte zu sein: {2}.
