...
ASSERT_RANGE=Inserire un valore compreso tra {1} e {2}.
#XMSG: Enter a valuematching the pattern /^abc/.
ASSERT_FORMAT=Inserire un valore corrispondente al modello {1}.
#XMSG: Enter one of the allowed values: High,Medium,Low. // Implementation still provides 2 values
ASSERT_ENUM=Inserire uno dei valori consentiti: {1}.
#XMSG: Provide the missing value. // Error text displayed on a field, in case a mandatory value is not set.
ASSERT_MANDATORY=Fornire il valore mancante.
#XMSG: Target with this key doesn't exist.
ASSERT_TARGET=La destinazione con questa chiave non esiste.

# Aggregating Error

#XMSG
MULTIPLE_ERRORS=Si sono verificati pi\u00F9 errori, vedere i dettagli sotto.
...
INVALID_FLOW_TRANSITION_SINGLE=L'azione "{0}" richiede che "{1}" sia "{2}".
#XMSG: Action "cancelTravel" requires "travelStatus" to be one of the following values: Open,Accepted.
INVALID_FLOW_TRANSITION_MULTI=L'azione "{0}" richiede che "{1}" sia uno dei seguenti valori: {2}.
